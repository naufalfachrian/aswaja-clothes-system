...
public class CustomerGridFrame extends javax.swing.JFrame implements MouseListener {
     ...
     */
    public CustomerGridFrame(String filterByNoTelepon) {
        initComponents();
        initCustomers(filterByNoTelepon);
        initTableListener();
    }
    ...
    private void initCustomers(String byNoTelepon) {
        ...
        if (byNoTelepon.isEmpty()) {
           listCustomer = new ConnectionManager().getCustomers();
            ...
            listCustomer = new ConnectionManager().getCustomersByNoTelepon(byNoTelepon);
        }
