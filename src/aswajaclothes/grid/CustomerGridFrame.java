 ...
 * @author Satrio
 */
public class CustomerGridFrame extends javax.swing.JFrame implements MouseListener {
    ...
    public CustomerGridFrame(FilterUtil.FilterType filter, String valueFilter) {
        initComponents();
        initCustomers(filter, valueFilter);
        initTableListener();
    }
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        if (tfNama.getText().isEmpty()){
            initCustomers(FilterUtil.FilterType.NONE, "");
        } else {
            initCustomers(FilterUtil.FilterType.NAMA, tfNama.getText());
        }
    }//GEN-LAST:event_btnCariActionPerformed

    private void initCustomers(FilterUtil.FilterType filter, String valueFilter) {
        String[] customerColumn = new String [] { "Kode", "Nama", "Alamat", "No Telepon"};
        ...
        for (Kustomer customer : listCustomer) {
            ...
            customersRow.add(rowData);
        }
        TableModel tblModel = new DefaultTableModel(customersRow.toArray(new String[][]{}), customerColumn){
            @Override
